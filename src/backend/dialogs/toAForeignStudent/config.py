...
Для иностранных абитуриентов, не владеющих или плохо владеющих русским языком, в Университете ИТМО действует Подготовительное отделение.
    ...
    "en-US": {
        "tts": """ITMO University is a leading Russian university in the field of information and photonic technologies, and one of the few Russian universities with the status of a national research university.
