...
def isTriggeredBench(event):
    ...
    ) and isInLastContext(event, "toAForeignStudent")
...
toAForeignStudentBench = {
    "getResponse": getBenchResponse,
    "isTriggered": isTriggeredBench,
}
toAForeignStudentAdd = {"getResponse": getResponseAdd, "isTriggered": isTriggeredAdd}
toAForeignStudentDocum = {
    "getResponse": getResponseDocum,
    "isTriggered": isTriggeredDocum,
}
toAForeignStudentMag = {"getResponse": getResponseMag, "isTriggered": isTriggeredMag}
toAForeignStudentInter = {
    "getResponse": getInterResponse,
    "isTriggered": isTriggeredInter,
}
