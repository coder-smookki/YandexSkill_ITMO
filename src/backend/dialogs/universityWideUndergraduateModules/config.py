...
config = {
    "ru-RU": {
        "tts":
            """
    Общеуниверситетские модули это то, с чего начинается обучение в Университете ИТМО, как в бакалавриате, так и в магистратуре. Это блок фундаментальной подготовки, на базе которого студенты приступают к изучению профессиональных дисциплин. Всё продумано: сначала формируются soft skills, необходимые для жизни и работы в условиях цифровой экономики. После этого, в зависимости от образовательной программы и специализации hard skills.  
    Цифровая культура.
    Предпринимательская культура или Технологическое предпринимательство.
    Иностранный язык 1 курс (2022 по 2023 год).
    Иностранный язык со 2 по четвертый курс (2022 по 2023 год).
    Soft Skills.
    Мышление.
