...
tts = \
    """
    Вы направились в категорию "Как подать заявку на получение документа о предыдуем образование?" Вам необходимо перейти на портал ИСУ, а дальше все просто! Подайте заявку через ту форму, которую предлагает система.
    """
